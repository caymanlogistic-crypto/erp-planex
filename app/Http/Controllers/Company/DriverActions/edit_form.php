...
if($driver&&($_SESSION['role_code']??'')==='logist'&&!$service->checkLogistCanEdit($localPdo,(int)$id,(int)($_SESSION['user_id']??0),(int)($driver['created_by_user_id']??0))){denyEntityAccess();}
