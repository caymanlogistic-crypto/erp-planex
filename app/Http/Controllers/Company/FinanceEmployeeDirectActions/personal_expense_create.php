...
use App\Service\FinanceEmployeeDirectExpenseService;
...
try {
    ...
    $event = FinanceEmployeeDirectExpenseService::create(
        $pdo,
        $_POST,
        [
    ...
    $_SESSION['employee_payments_success'] = 'Расход сотрудника сохранён напрямую. Техническая касса не использована.';
