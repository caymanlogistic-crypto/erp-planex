...
if (!function_exists('renderClientContactFields')) {
    function renderClientContactFields(array $contacts, array $errors = []): void
    {
        ...
        ?>
        <div class="client-contacts" data-client-contacts>
            <div class="client-contacts-list" data-client-contacts-list>
                <?php foreach ($contacts as $index => $contact): ?>
                    <?php $rowErrors = $errors[$index] ?? []; ?>
                    <div class="client-contact-row" data-contact-row>
                        ...
                        <button type="button" class="file-remove client-contact-remove" data-remove-contact aria-label="Удалить контакт">&times;</button>
                    </div>
                <?php endforeach; ?>
            </div>
