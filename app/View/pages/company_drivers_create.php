...
<div class="page-head">
    ...
    <div class="page-head-actions">
        <a href="/company/drivers?company_id=<?= $companyId ?>" class="btn btn-ghost">← К списку</a>
    </div>
</div>
...
<div class="page-head">
    ...
    <div class="page-head-actions">
        <a href="/company/drivers?company_id=<?= $companyId ?>" class="btn btn-primary">← К списку</a>
    </div>
</div>
...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="form-actions" style="margin-top:16px">
            <a href="/company/drivers?company_id=<?= $companyId ?>" class="btn btn-primary">← К списку водителей</a>
            <a href="/company/drivers/create?company_id=<?= $companyId ?>" class="btn btn-ghost">Создать ещё</a>
        </div>
    </div>
</div>
...
<form method="post" action="/company/drivers/create?company_id=<?= $companyId ?>" class="panel">
    <div class="panel-body">
