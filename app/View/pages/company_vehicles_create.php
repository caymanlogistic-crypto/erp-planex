...
<div class="page-head">
    ...
    <div class="page-head-actions">
        <a href="/company/vehicles?company_id=<?= $companyId ?>" class="btn btn-ghost">← К списку</a>
    </div>
</div>
...
<div class="page-head">
    ...
    <div class="page-head-actions">
        <a href="/company/vehicles?company_id=<?= $companyId ?>" class="btn btn-primary">← К списку</a>
    </div>
</div>
...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="form-actions" style="margin-top:16px">
            <a href="/company/vehicles?company_id=<?= $companyId ?>" class="btn btn-primary">← К списку</a>
            <a href="/company/vehicles/create?company_id=<?= $companyId ?>" class="btn btn-ghost">Добавить ещё</a>
        </div>
    </div>
</div>
...
<form method="post" action="/company/vehicles/create?company_id=<?= $companyId ?>" class="panel">
    <div class="panel-body">
