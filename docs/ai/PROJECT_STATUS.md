...
2026-06-11 — очищена и синхронизирована документация docs; обновлены правила UI/UX-дизайнера и workflow MD-шаблонов страниц: дизайнер создаёт/обновляет `docs/ui/pages/[page].md`, кодер реализует по шаблону, QA проверяет по шаблону, архитектор принимает или запускает второй круг.
