...
require_once dirname(__DIR__) . '/app/Support/environment.php';
...
foreach ($companies as $company) {
    ...
    try {
        ...
        $columns = [
            ...
            ['bank_transactions', 'classification_locked'],
            ['bank_transactions', 'linked_cash_transaction_id'],
            ['finance_operations', 'cash_flow_center_id'],
            ['finance_operations', 'classification_status'],
            ['finance_matching_rules', 'target_cash_flow_center_id'],
            ['finance_matching_rules', 'target_cash_account_id'],
            ['finance_matching_rules', 'deleted_at'],
        ];
