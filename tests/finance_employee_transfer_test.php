...
$assert(!str_contains($view, 'employee-transfer-edit-modal'), 'page must expose no obsolete transfer edit modal');
$assert(!str_contains($view, 'Удалить передачу'), 'page must expose no obsolete transfer delete control');
