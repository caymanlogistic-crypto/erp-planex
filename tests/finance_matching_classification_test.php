...
$validation=file_get_contents(__DIR__.'/../app/Service/FinanceMatchingRuleValidationTrait.php');ok(str_contains($validation,"'auto_apply'=>1"),'saved rules normalize to automatic application');
